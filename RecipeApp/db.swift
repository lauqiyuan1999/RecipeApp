...
class DBHelper {
    ...
    func createTable(){
        let query = "CREATE TABLE IF NOT EXISTS NRecipes(Rid INTEGER PRIMARY KEY AUTOINCREMENT, RecipeName TEXT, Ingredient TEXT, Step TEXT, RecipeType TEXT, Img TEXT);"
    ...
    func insertData(recipeName: String, ingredient: String, step: String, recipeType:String, img:String){
        let insertQuery = "INSERT INTO NRecipes (Rid, RecipeName, Ingredient, Step, RecipeType, Img) VALUES(?, ?, ?, ?, ?, ?)"
    ...
    func readRecipe() -> [Recipe]  {
        ...
        if sqlite3_prepare_v2(db, readQuery, -1, &statement, nil) == SQLITE_OK{
            while sqlite3_step(statement) == SQLITE_ROW {
                ...
                let model = Recipe(Rid: String(id), recipeName: name, ingredient: ingredient, step: step, recipeType: recipeType, imageFilePath: img)
    ...
    func readParticularRecipe(id: String) -> Recipe  {
        //var list
        var listRecipe = Recipe(Rid: "", recipeName: "", ingredient: "", step: "", recipeType: "", imageFilePath: "")
    ...
    func updateRecipe(id: String,recipeName: String, ingredient: String, step: String, recipeType:String, img:String){
        let updateQuery = "UPDATE NRecipes SET RecipeName = '\(recipeName)', Ingredient = '\(ingredient)', Step = '\(step)', RecipeType = '\(recipeType)', Img = '\(img)' WHERE Rid = \(id);"
