//
//  ModifyRecipeViewController.swift
//  RecipeApp
//
...
class ModifyRecipeViewController:UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate{
    ...
    var modifyRecipe = Recipe(Rid: "", recipeName: "", ingredient: "", step: "", recipeType: "", imageFilePath: "")
    ...
    @IBAction func updateRecipe(_ sender: Any) {
        ...
        if (!validate()){
            ...
            alert.addAction(UIAlertAction(title: "Update", style: UIAlertAction.Style.default,handler: { [self]_ in
                ...
                self.db.updateRecipe(id: self.modifyRecipe.Rid, recipeName: recipeNameTextField.text!, ingredient: ingredientTextField.text!, step: stepTextField.text!, recipeType: (recipeTypeButton.titleLabel?.text?.lowercased())!, img: savedUrl!)
